      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <Card className="p-6 shadow-card hover:shadow-elegant transition-all duration-300 mb-8">
            ...
            <div className="grid grid-cols-2 gap-3">
              {interests.map((interest, index) => (
                <Card key={index} className="p-4 shadow-card hover:shadow-elegant transition-all duration-300 text-center">
